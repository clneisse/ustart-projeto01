...
#Criar grupo produto
dotnet ef migrations add grupo -c UStartContext --project ../Infrastructure/Infrastructure.csproj
...
#Criar produto
cd API
dotnet ef migrations add obra -c UStartContext --project ../Infrastructure/Infrastructure.csproj
