...
namespace UStart.Infrastructure.Migrations
{
    ...
    [Migration("20211108133632_grupo")]
    partial class grupo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UStart.Domain.Entities.Grupo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("UStart.Domain.Entities.Obra", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("Serviços")
                        .HasColumnType("text")
                        .HasColumnName("serviços");

                    b.HasKey("Id")
                        .HasName("pk_obras");

                    b.HasIndex("GrupoId")
                        .HasDatabaseName("ix_obras_grupo_id");
            ...
            modelBuilder.Entity("UStart.Domain.Entities.Obra", b =>
                {
                    b.HasOne("UStart.Domain.Entities.Grupo", "Grupo")
                        .WithMany()
                        .HasForeignKey("GrupoId")
                        .HasConstraintName("fk_obras_grupos_grupo_id")
